...
var require_fetch = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var { PassThrough: PassThrough$3 } = __require("stream");
	var Cookies = require_cookies();
	var packageData = (init_package(), __toCommonJS(package_exports).default);
...
var require_base64 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var { Transform: Transform$7 } = __require("stream");
	/**
...
var require_qp = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var { Transform: Transform$6 } = __require("stream");
	/**
...
var require_last_newline = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var { Transform: Transform$5 } = __require("stream");
...
var require_le_windows = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var { Transform: Transform$4 } = __require("stream");
	/**
...
var require_relaxed_body = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var { Transform: Transform$1 } = __require("stream");
...
var require_sign = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	module.exports = (headers, hashAlgo, bodyHash, options) => {
		...
		const signer = crypto$4.createSign(("rsa-" + hashAlgo).toUpperCase());
		...
		_convertDataImages(mail, callback) {
			...
			mail.resolveContent(mail.data, "html", {
				...
				html = (html || "").toString().replace(/(<img\b[^<>]{0,1024} src\s{0,20}=[\s"']{0,20})(data:([^;]+);[^"'>\s]+)/gi, (match, prefix, dataUri, mimeType) => {
					const cid = crypto$2.randomBytes(10).toString("hex") + "@localhost";
...
var require_smtp_connection = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var shared = require_shared();
	var CONNECTION_TIMEOUT = 120 * 1e3;
	var SOCKET_TIMEOUT = 600 * 1e3;
...
var Aliyun, AliyunQiye, AOL, Aruba, Bluewin, BOL, DebugMail, Disroot, DynectEmail, ElasticEmail, Ethereal, FastMail, GandiMail, Gmail, GmailWorkspace, GMX, Godaddy, GodaddyAsia, GodaddyEurope, Hotmail, iCloud, Infomaniak, KolabNow, Loopia, Loops, Maildev, MailerSend, Mailgun, Mailjet, Mailosaur, Mailtrap, Mandrill, Naver, OhMySMTP, One, OpenMailBox, Outlook365, Postmark, Proton, QQ, QQex, Resend, Runbox, SendCloud, SendGrid, SendinBlue, SendPulse, SES, Seznam, SMTP2GO, Sparkpost, Tipimail, Tutanota, Yahoo, Yandex, Zimbra, Zoho, services_default;
...
var require_well_known = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var services = (init_services(), __toCommonJS(services_exports).default);
	var normalized = {};
	...
	var SESTransport = class extends EventEmitter {
		...
		*/
		verify(callback) {
			...
			this.getRegion(() => {
				const command = new this.ses.SendEmailCommand(sesMessage);
				this.ses.sesClient.send(command).then(() => cb(null)).catch((err) => cb(err));
			});
			return promise;
		}
	};
...
//#endregion
//#region node_modules/nodemailer/lib/nodemailer.js
var require_nodemailer = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
export { require_nodemailer as t };
